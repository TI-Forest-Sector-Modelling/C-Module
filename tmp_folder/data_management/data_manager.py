from tmp_folder.parameters.paths import (PKL_RESULTS_INPUT, ADD_INFO_CARBON_PATH, ADD_INFO_COUNTRY, FAOSTAT_DATA,
                                         FRA_DATA)
from tmp_folder.parameters.defines import (VarNames, ParamNames, CountryConstants)
