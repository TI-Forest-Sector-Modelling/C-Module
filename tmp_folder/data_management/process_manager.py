from tmp_folder.data_management.data_manager import DataManager
from tmp_folder.parameters.paths import (FAOSTAT_DATA, FRA_DATA, PKL_CARBON_OUTPUT, PKL_UPDATED_TIMBA_OUTPUT,
                                         OUTPUT_FOLDER)
from tmp_folder.parameters.defines import (VarNames, ParamNames)
